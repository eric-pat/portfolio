const id = "editions-le-garage.md";
						const collection = "work";
						const slug = "editions-le-garage";
						...
						const data = {title:"Éditions le garage",description:"Site créé en collaboration avec l'entreprise Zentux (86), utilisant leur CMS Gaïa.\n",publishDate:new Date(1625184000000),tags:["CMS","Template","Html/Css"],img:"/assets/editions-le-garage.webp",img_alt:"Image du site des Éditions le garage"};
						const _internal = {
							type: 'content',
							filePath: "/Users/eric-pat/portfolio/src/content/work/editions-le-garage.md",
