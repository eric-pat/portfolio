const id = "chez-nos-producteurs.md";
						const collection = "work";
						const slug = "chez-nos-producteurs";
						...
						const data = {title:"Chez nos producteurs",description:"Site créé en collaboration avec l'entreprise Zentux (86), utilisant leur CMS Gaïa.\n",publishDate:new Date(1622505600000),tags:["CMS","Template","Html/Css"],img:"/assets/chez-nos-producteurs.webp",img_alt:"Image du site Chez nos producteurs"};
						const _internal = {
							type: 'content',
							filePath: "/Users/eric-pat/portfolio/src/content/work/chez-nos-producteurs.md",
