const id = "cse.md";
						...
						const data = {title:"CSE",description:"Site créé en collaboration avec l'entreprise Digi-websolutions (24).\n",publishDate:new Date(1698796800000),tags:["Symfony","Fullcalandar","Template","UIkit"],img:"/assets/ce-rottersac.webp",img_alt:"Image du site du CSE Rottersac"};
						const _internal = {
							type: 'content',
							filePath: "/Users/eric-pat/portfolio/src/content/work/cse.md",
